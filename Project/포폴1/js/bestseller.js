$(function(){
    let arr = ["달러구트 꿈 백화점 2","프로젝트 헤일메리","하얀 늑대들","물고기는 존재하지 않는다","타이탄의 도구들","무의식은 답을 알고 있다","죽여 마땅한 사람들","유괴의 날","천 개의 파랑","부의 추월차선","불안한 사람들","문명 1","데일 카네기 인간관계론","아무도 알려주지 않은 4차 산업혁명 이야기","조인계획","피를 마시는 새","눈물을 마시는 새","뉴 맵"];
